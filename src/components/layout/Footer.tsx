      ...
      <div className="container">
        ...
        <div className="mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-row items-center gap-6 relative z-50 isolate">
            ...
            <a href="https://wa.me/573223842813" target="_blank" rel="noopener noreferrer" aria-label="Escríbenos por WhatsApp" className="block relative z-50 pointer-events-auto cursor-pointer text-gray-400 hover:text-gold transition-all duration-300 hover:scale-110">
